...
public class PortfolioTest {
	...
	private double accountTransferNet(ReceptiveAccount account) {
		final AccountTransferVisitor aVisitor = new AccountTransferVisitor();
		account.transactions().forEach(transaction -> transaction.accept(aVisitor));

		return aVisitor.netValue();
	}
